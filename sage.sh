dl() {
printf "\n Downloading files....\n"
wget -q https://raw.githubusercontent.com/rooted-cyber/sa-genrated/main/generate_drive_token.py
wget -q https://raw.githubusercontent.com/rooted-cyber/sa-genrated/main/gen_sa_accounts.py
}
gns() {
printf "\n Generate sa files\n"
